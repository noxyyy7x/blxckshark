...
export const ADMIN_SECTIONS = [
  ...
  { key: 'athleteApplications', label: 'Athlete Applications', href: '/admin/athlete-applications' },
  { key: 'discounts', label: 'Discount Codes', href: '/admin/discounts' },
  { key: 'cashouts', label: 'Cashout Requests', href: '/admin/cashouts' },
  { key: 'referralReview', label: 'Referral Review', href: '/admin/referral-review' },
  ...
  { key: 'settings', label: 'Site Settings', href: '/admin/settings' },
]
